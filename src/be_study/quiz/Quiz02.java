...
public class Quiz02 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int monitorLength = 24;
		String monitorColor = "black";
		boolean hasHDMI = true;
		boolean isSoundable = false;
		...
		*/
		...
		String englishScore = "90";
		String artScore = "70";
		int sumScore = Integer.parseInt(mathScore) + Integer.parseInt(englishScore) + Integer.parseInt(artScore);
		System.out.println("총 점수는 " + sumScore + "점 입니다.");
