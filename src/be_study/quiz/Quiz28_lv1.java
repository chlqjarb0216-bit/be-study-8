...
public class Quiz28_lv1 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.print("정지 횟수 : ");
		int stop = scanner.nextInt();
		int floor = 0;
		for (int cnt = 0; cnt < (stop < n ? stop : n);) {
			if (++floor == sorted[cnt]) {
				System.out.println(floor + "층입니다.");
				cnt++;
			}
		}
		System.out.println(floor + "층 점검 중. 승객분들은 계단을 이용해주시기 바랍니다.");
	}
