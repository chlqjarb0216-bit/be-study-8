package be_study.quiz.quiz47.q4;
...
class Currency {
	...
	protected Currency(double amount, String notation) {
		this.amount = amount;
		this.notation = notation;
	}

	protected String toString(String name) {
		return "%s: %.2f %s".formatted(name, this.amount, this.notation);
	}
}
